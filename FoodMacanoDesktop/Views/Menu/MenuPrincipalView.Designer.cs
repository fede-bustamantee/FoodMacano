namespace FoodMacanoDesktop.Views.Menu
{
    partial class MenuPrincipalView
    {
        ...
        private void InitializeComponent()
        {
            ...
            SubmenuReabastecimiento = new Panel();
            btnInforme = new FontAwesome.Sharp.IconButton();
            btnReabastecimiento = new FontAwesome.Sharp.IconButton();
            SubmenuLocalidades = new Panel();
            btnArchivoLocalidades = new FontAwesome.Sharp.IconButton();
            btnLocalidades = new FontAwesome.Sharp.IconButton();
            SubmenuSalir = new Panel();
            btnSalirDelSistema = new FontAwesome.Sharp.IconButton();
            btnSalir = new FontAwesome.Sharp.IconButton();
            SubmenuDatos = new Panel();
            btnDatos = new FontAwesome.Sharp.IconButton();
            btnNosotros = new FontAwesome.Sharp.IconButton();
            SubmenuEncargues = new Panel();
            btnListaEncargues = new FontAwesome.Sharp.IconButton();
            btnEncargues = new FontAwesome.Sharp.IconButton();
            SubmenuPedidos = new Panel();
            btnBebidas = new FontAwesome.Sharp.IconButton();
            btnSanguches = new FontAwesome.Sharp.IconButton();
            btnHamburguesas = new FontAwesome.Sharp.IconButton();
            btnTodos = new FontAwesome.Sharp.IconButton();
            ...
            SubmenuReabastecimiento.SuspendLayout();
            SubmenuLocalidades.SuspendLayout();
            SubmenuSalir.SuspendLayout();
            SubmenuDatos.SuspendLayout();
            SubmenuEncargues.SuspendLayout();
            ...
            MenuLateral.Controls.Add(btnReabastecimiento);
            MenuLateral.Controls.Add(SubmenuLocalidades);
            MenuLateral.Controls.Add(btnLocalidades);
            MenuLateral.Controls.Add(SubmenuSalir);
            MenuLateral.Controls.Add(btnSalir);
            MenuLateral.Controls.Add(SubmenuDatos);
            MenuLateral.Controls.Add(btnNosotros);
            MenuLateral.Controls.Add(SubmenuEncargues);
            ...
            MenuLateral.Size = new Size(197, 701);
            ...
            SubmenuInfo.Location = new Point(0, 1011);
            ...
            SubmenuConfiguracion.Location = new Point(0, 686);
            ...
            // btnConfigSector
            // 
            btnConfigSector.Dock = DockStyle.Top;
            btnConfigSector.FlatAppearance.BorderSize = 0;
            btnConfigSector.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnConfigSector.FlatStyle = FlatStyle.Flat;
            btnConfigSector.ForeColor = Color.White;
            btnConfigSector.IconChar = FontAwesome.Sharp.IconChar.Whmcs;
            btnConfigSector.IconColor = Color.Fuchsia;
            ...
            // btnConfigEmpleados
            // 
            btnConfigEmpleados.Dock = DockStyle.Top;
            btnConfigEmpleados.FlatAppearance.BorderSize = 0;
            btnConfigEmpleados.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnConfigEmpleados.FlatStyle = FlatStyle.Flat;
            btnConfigEmpleados.ForeColor = Color.White;
            btnConfigEmpleados.IconChar = FontAwesome.Sharp.IconChar.UsersCog;
            btnConfigEmpleados.IconColor = Color.Fuchsia;
            btnConfigEmpleados.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnConfigEmpleados.IconSize = 30;
            btnConfigEmpleados.ImageAlign = ContentAlignment.MiddleLeft;
            btnConfigEmpleados.Location = new Point(0, 40);
            btnConfigEmpleados.Name = "btnConfigEmpleados";
            ...
            // btnConfigProductos
            // 
            btnConfigProductos.Dock = DockStyle.Top;
            btnConfigProductos.FlatAppearance.BorderSize = 0;
            btnConfigProductos.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnConfigProductos.FlatStyle = FlatStyle.Flat;
            btnConfigProductos.ForeColor = Color.White;
            btnConfigProductos.IconChar = FontAwesome.Sharp.IconChar.CartPlus;
            btnConfigProductos.IconColor = Color.Fuchsia;
            btnConfigProductos.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnConfigProductos.IconSize = 30;
            btnConfigProductos.ImageAlign = ContentAlignment.MiddleLeft;
            btnConfigProductos.Location = new Point(0, 0);
            btnConfigProductos.Name = "btnConfigProductos";
            btnConfigProductos.Padding = new Padding(20, 0, 0, 0);
            btnConfigProductos.Size = new Size(176, 40);
            btnConfigProductos.TabIndex = 2;
            btnConfigProductos.Text = "Productos";
            btnConfigProductos.TextAlign = ContentAlignment.MiddleLeft;
            btnConfigProductos.TextImageRelation = TextImageRelation.ImageBeforeText;
            btnConfigProductos.UseVisualStyleBackColor = true;
            btnConfigProductos.Click += btnConfigProductos_Click;
            // 
            // btnConfiguracion
            // 
            btnConfiguracion.Dock = DockStyle.Top;
            btnConfiguracion.FlatAppearance.BorderSize = 0;
            btnConfiguracion.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnConfiguracion.FlatStyle = FlatStyle.Flat;
            btnConfiguracion.ForeColor = Color.White;
            btnConfiguracion.IconChar = FontAwesome.Sharp.IconChar.Cog;
            btnConfiguracion.IconColor = Color.Fuchsia;
            ...
            btnConfiguracion.Location = new Point(0, 641);
            ...
            // 
            // SubmenuReabastecimiento
            // 
            SubmenuReabastecimiento.BackColor = Color.FromArgb(35, 32, 39);
            SubmenuReabastecimiento.Controls.Add(btnInforme);
            SubmenuReabastecimiento.Dock = DockStyle.Top;
            SubmenuReabastecimiento.Location = new Point(0, 601);
            SubmenuReabastecimiento.Name = "SubmenuReabastecimiento";
            SubmenuReabastecimiento.Size = new Size(176, 40);
            SubmenuReabastecimiento.TabIndex = 20;
            // 
            // btnInforme
            // 
            btnInforme.Dock = DockStyle.Top;
            btnInforme.FlatAppearance.BorderSize = 0;
            btnInforme.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnInforme.FlatStyle = FlatStyle.Flat;
            btnInforme.ForeColor = Color.White;
            btnInforme.IconChar = FontAwesome.Sharp.IconChar.FileInvoiceDollar;
            btnInforme.IconColor = Color.Fuchsia;
            btnInforme.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnInforme.IconSize = 25;
            btnInforme.ImageAlign = ContentAlignment.MiddleLeft;
            btnInforme.Location = new Point(0, 0);
            btnInforme.Name = "btnInforme";
            btnInforme.Padding = new Padding(20, 0, 0, 0);
            btnInforme.Size = new Size(176, 40);
            ...
            // btnReabastecimiento
            // 
            btnReabastecimiento.Dock = DockStyle.Top;
            btnReabastecimiento.FlatAppearance.BorderSize = 0;
            btnReabastecimiento.FlatAppearance.MouseDownBackColor = Color.Transparent;
            btnReabastecimiento.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnReabastecimiento.FlatStyle = FlatStyle.Flat;
            btnReabastecimiento.Font = new Font("Segoe UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
            btnReabastecimiento.ForeColor = Color.White;
            btnReabastecimiento.IconChar = FontAwesome.Sharp.IconChar.SackDollar;
            btnReabastecimiento.IconColor = Color.Fuchsia;
            btnReabastecimiento.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnReabastecimiento.IconSize = 30;
            btnReabastecimiento.ImageAlign = ContentAlignment.MiddleLeft;
            btnReabastecimiento.Location = new Point(0, 556);
            btnReabastecimiento.Name = "btnReabastecimiento";
            btnReabastecimiento.Padding = new Padding(5, 0, 0, 0);
            btnReabastecimiento.Size = new Size(176, 45);
            btnReabastecimiento.TabIndex = 19;
            btnReabastecimiento.Text = "Reabastecimiento";
            ...
            // SubmenuLocalidades
            // 
            SubmenuLocalidades.BackColor = Color.FromArgb(35, 32, 39);
            SubmenuLocalidades.Controls.Add(btnArchivoLocalidades);
            SubmenuLocalidades.Dock = DockStyle.Top;
            SubmenuLocalidades.Location = new Point(0, 516);
            SubmenuLocalidades.Name = "SubmenuLocalidades";
            SubmenuLocalidades.Size = new Size(176, 40);
            SubmenuLocalidades.TabIndex = 14;
            // 
            // btnArchivoLocalidades
            // 
            btnArchivoLocalidades.Dock = DockStyle.Top;
            btnArchivoLocalidades.FlatAppearance.BorderSize = 0;
            btnArchivoLocalidades.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnArchivoLocalidades.FlatStyle = FlatStyle.Flat;
            btnArchivoLocalidades.ForeColor = Color.White;
            btnArchivoLocalidades.IconChar = FontAwesome.Sharp.IconChar.LocationArrow;
            btnArchivoLocalidades.IconColor = Color.Fuchsia;
            btnArchivoLocalidades.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnArchivoLocalidades.IconSize = 30;
            btnArchivoLocalidades.ImageAlign = ContentAlignment.MiddleLeft;
            btnArchivoLocalidades.Location = new Point(0, 0);
            btnArchivoLocalidades.Name = "btnArchivoLocalidades";
            ...
            // btnLocalidades
            // 
            btnLocalidades.Dock = DockStyle.Top;
            btnLocalidades.FlatAppearance.BorderSize = 0;
            btnLocalidades.FlatAppearance.MouseDownBackColor = Color.Transparent;
            btnLocalidades.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnLocalidades.FlatStyle = FlatStyle.Flat;
            btnLocalidades.Font = new Font("Segoe UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
            btnLocalidades.ForeColor = Color.White;
            btnLocalidades.IconChar = FontAwesome.Sharp.IconChar.MapLocationDot;
            btnLocalidades.IconColor = Color.Fuchsia;
            btnLocalidades.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnLocalidades.IconSize = 30;
            btnLocalidades.ImageAlign = ContentAlignment.MiddleLeft;
            btnLocalidades.Location = new Point(0, 471);
            ...
            SubmenuSalir.Location = new Point(0, 1051);
            ...
            // btnSalirDelSistema
            // 
            btnSalirDelSistema.Dock = DockStyle.Bottom;
            btnSalirDelSistema.FlatAppearance.BorderSize = 0;
            btnSalirDelSistema.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnSalirDelSistema.FlatStyle = FlatStyle.Flat;
            btnSalirDelSistema.ForeColor = Color.White;
            btnSalirDelSistema.IconChar = FontAwesome.Sharp.IconChar.Close;
            btnSalirDelSistema.IconColor = Color.Fuchsia;
            btnSalirDelSistema.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnSalirDelSistema.IconSize = 30;
            btnSalirDelSistema.ImageAlign = ContentAlignment.MiddleLeft;
            btnSalirDelSistema.Location = new Point(0, 0);
            btnSalirDelSistema.Name = "btnSalirDelSistema";
            btnSalirDelSistema.Padding = new Padding(20, 0, 0, 0);
            btnSalirDelSistema.Size = new Size(176, 40);
            btnSalirDelSistema.TabIndex = 1;
            ...
            btnSalir.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnSalir.FlatStyle = FlatStyle.Flat;
            btnSalir.ForeColor = Color.White;
            btnSalir.IconChar = FontAwesome.Sharp.IconChar.SignOutAlt;
            btnSalir.IconColor = Color.Fuchsia;
            btnSalir.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnSalir.IconSize = 30;
            btnSalir.ImageAlign = ContentAlignment.MiddleLeft;
            btnSalir.Location = new Point(0, 1091);
            ...
            SubmenuDatos.Controls.Add(btnDatos);
            SubmenuDatos.Dock = DockStyle.Top;
            SubmenuDatos.Location = new Point(0, 431);
            SubmenuDatos.Name = "SubmenuDatos";
            SubmenuDatos.Size = new Size(176, 40);
            SubmenuDatos.TabIndex = 6;
            // 
            // btnDatos
            // 
            btnDatos.Dock = DockStyle.Top;
            btnDatos.FlatAppearance.BorderSize = 0;
            btnDatos.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnDatos.FlatStyle = FlatStyle.Flat;
            btnDatos.ForeColor = Color.White;
            btnDatos.IconChar = FontAwesome.Sharp.IconChar.PeopleGroup;
            btnDatos.IconColor = Color.Fuchsia;
            btnDatos.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnDatos.IconSize = 30;
            btnDatos.ImageAlign = ContentAlignment.MiddleLeft;
            btnDatos.Location = new Point(0, 0);
            btnDatos.Name = "btnDatos";
            btnDatos.Padding = new Padding(20, 0, 0, 0);
            btnDatos.Size = new Size(176, 40);
            btnDatos.TabIndex = 2;
            btnDatos.Text = "Datos";
            ...
            btnNosotros.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnNosotros.FlatStyle = FlatStyle.Flat;
            btnNosotros.ForeColor = Color.White;
            btnNosotros.IconChar = FontAwesome.Sharp.IconChar.Male;
            btnNosotros.IconColor = Color.Fuchsia;
            btnNosotros.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnNosotros.IconSize = 29;
            btnNosotros.ImageAlign = ContentAlignment.MiddleLeft;
            btnNosotros.Location = new Point(0, 388);
            btnNosotros.Name = "btnNosotros";
            btnNosotros.Padding = new Padding(5, 0, 0, 0);
            btnNosotros.Size = new Size(176, 43);
            btnNosotros.TabIndex = 5;
            ...
            SubmenuEncargues.Controls.Add(btnListaEncargues);
            SubmenuEncargues.Dock = DockStyle.Top;
            SubmenuEncargues.Location = new Point(0, 348);
            SubmenuEncargues.Name = "SubmenuEncargues";
            SubmenuEncargues.Size = new Size(176, 40);
            SubmenuEncargues.TabIndex = 4;
            // 
            // btnListaEncargues
            // 
            btnListaEncargues.BackColor = Color.FromArgb(35, 32, 39);
            btnListaEncargues.Dock = DockStyle.Top;
            btnListaEncargues.FlatAppearance.BorderSize = 0;
            btnListaEncargues.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnListaEncargues.FlatStyle = FlatStyle.Flat;
            btnListaEncargues.ForeColor = Color.White;
            btnListaEncargues.IconChar = FontAwesome.Sharp.IconChar.CartArrowDown;
            btnListaEncargues.IconColor = Color.Fuchsia;
            btnListaEncargues.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnListaEncargues.IconSize = 30;
            btnListaEncargues.ImageAlign = ContentAlignment.MiddleLeft;
            btnListaEncargues.Location = new Point(0, 0);
            btnListaEncargues.Name = "btnListaEncargues";
            btnListaEncargues.Padding = new Padding(20, 0, 0, 0);
            btnListaEncargues.Size = new Size(176, 40);
            btnListaEncargues.TabIndex = 0;
            btnListaEncargues.Text = "Listado";
            btnListaEncargues.TextAlign = ContentAlignment.MiddleLeft;
            btnListaEncargues.TextImageRelation = TextImageRelation.ImageBeforeText;
            btnListaEncargues.UseVisualStyleBackColor = false;
            btnListaEncargues.Click += btnListaEncargues_Click;
            // 
            // btnEncargues
            // 
            btnEncargues.Dock = DockStyle.Top;
            btnEncargues.FlatAppearance.BorderSize = 0;
            btnEncargues.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnEncargues.FlatStyle = FlatStyle.Flat;
            btnEncargues.ForeColor = Color.White;
            btnEncargues.IconChar = FontAwesome.Sharp.IconChar.CartShopping;
            btnEncargues.IconColor = Color.Fuchsia;
            ...
            SubmenuPedidos.Controls.Add(btnBebidas);
            SubmenuPedidos.Controls.Add(btnSanguches);
            SubmenuPedidos.Controls.Add(btnHamburguesas);
            SubmenuPedidos.Controls.Add(btnTodos);
            SubmenuPedidos.Dock = DockStyle.Top;
            SubmenuPedidos.Location = new Point(0, 131);
            SubmenuPedidos.Name = "SubmenuPedidos";
            SubmenuPedidos.Size = new Size(176, 172);
            SubmenuPedidos.TabIndex = 2;
            // 
            // btnBebidas
            // 
            btnBebidas.BackColor = Color.FromArgb(35, 32, 39);
            btnBebidas.Dock = DockStyle.Top;
            btnBebidas.FlatAppearance.BorderSize = 0;
            btnBebidas.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnBebidas.FlatStyle = FlatStyle.Flat;
            btnBebidas.Font = new Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnBebidas.ForeColor = Color.White;
            btnBebidas.IconChar = FontAwesome.Sharp.IconChar.UserFriends;
            btnBebidas.IconColor = Color.Fuchsia;
            btnBebidas.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnBebidas.IconSize = 30;
            btnBebidas.ImageAlign = ContentAlignment.MiddleLeft;
            btnBebidas.Location = new Point(0, 129);
            btnBebidas.Name = "btnBebidas";
            btnBebidas.Padding = new Padding(20, 0, 0, 0);
            btnBebidas.Size = new Size(176, 43);
            btnBebidas.TabIndex = 4;
            btnBebidas.Text = "Bebidas";
            btnBebidas.TextAlign = ContentAlignment.MiddleLeft;
            btnBebidas.TextImageRelation = TextImageRelation.ImageBeforeText;
            btnBebidas.UseVisualStyleBackColor = false;
            // 
            // btnSanguches
            // 
            btnSanguches.BackColor = Color.FromArgb(35, 32, 39);
            btnSanguches.Dock = DockStyle.Top;
            btnSanguches.FlatAppearance.BorderSize = 0;
            btnSanguches.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnSanguches.FlatStyle = FlatStyle.Flat;
            btnSanguches.Font = new Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnSanguches.ForeColor = Color.White;
            btnSanguches.IconChar = FontAwesome.Sharp.IconChar.UserFriends;
            btnSanguches.IconColor = Color.Fuchsia;
            btnSanguches.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnSanguches.IconSize = 30;
            btnSanguches.ImageAlign = ContentAlignment.MiddleLeft;
            btnSanguches.Location = new Point(0, 86);
            btnSanguches.Name = "btnSanguches";
            btnSanguches.Padding = new Padding(20, 0, 0, 0);
            btnSanguches.Size = new Size(176, 43);
            btnSanguches.TabIndex = 3;
            btnSanguches.Text = "Sanguches";
            btnSanguches.TextAlign = ContentAlignment.MiddleLeft;
            btnSanguches.TextImageRelation = TextImageRelation.ImageBeforeText;
            btnSanguches.UseVisualStyleBackColor = false;
            // 
            // btnHamburguesas
            // 
            btnHamburguesas.BackColor = Color.FromArgb(35, 32, 39);
            btnHamburguesas.Dock = DockStyle.Top;
            btnHamburguesas.FlatAppearance.BorderSize = 0;
            btnHamburguesas.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnHamburguesas.FlatStyle = FlatStyle.Flat;
            btnHamburguesas.Font = new Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnHamburguesas.ForeColor = Color.White;
            btnHamburguesas.IconChar = FontAwesome.Sharp.IconChar.UserFriends;
            btnHamburguesas.IconColor = Color.Fuchsia;
            btnHamburguesas.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnHamburguesas.IconSize = 30;
            btnHamburguesas.ImageAlign = ContentAlignment.MiddleLeft;
            btnHamburguesas.Location = new Point(0, 43);
            btnHamburguesas.Name = "btnHamburguesas";
            btnHamburguesas.Padding = new Padding(20, 0, 0, 0);
            btnHamburguesas.Size = new Size(176, 43);
            btnHamburguesas.TabIndex = 2;
            btnHamburguesas.Text = "Hamburguesas";
            btnHamburguesas.TextAlign = ContentAlignment.MiddleLeft;
            btnHamburguesas.TextImageRelation = TextImageRelation.ImageBeforeText;
            btnHamburguesas.UseVisualStyleBackColor = false;
            btnHamburguesas.Click += btnHamburguesas_Click;
            // 
            // btnTodos
            // 
            btnTodos.BackColor = Color.FromArgb(35, 32, 39);
            btnTodos.Dock = DockStyle.Top;
            btnTodos.FlatAppearance.BorderSize = 0;
            btnTodos.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnTodos.FlatStyle = FlatStyle.Flat;
            btnTodos.Font = new Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnTodos.ForeColor = Color.White;
            btnTodos.IconChar = FontAwesome.Sharp.IconChar.UserFriends;
            btnTodos.IconColor = Color.Fuchsia;
            btnTodos.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnTodos.IconSize = 30;
            btnTodos.ImageAlign = ContentAlignment.MiddleLeft;
            btnTodos.Location = new Point(0, 0);
            btnTodos.Name = "btnTodos";
            btnTodos.Padding = new Padding(20, 0, 0, 0);
            btnTodos.Size = new Size(176, 43);
            btnTodos.TabIndex = 1;
            btnTodos.Text = "Todos";
            btnTodos.TextAlign = ContentAlignment.MiddleLeft;
            btnTodos.TextImageRelation = TextImageRelation.ImageBeforeText;
            ...
            btnPedidos.FlatAppearance.MouseOverBackColor = Color.Orchid;
            btnPedidos.FlatStyle = FlatStyle.Flat;
            btnPedidos.Font = new Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnPedidos.ForeColor = Color.White;
            btnPedidos.IconChar = FontAwesome.Sharp.IconChar.UserLarge;
            btnPedidos.IconColor = Color.Fuchsia;
            btnPedidos.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnPedidos.IconSize = 25;
            ...
            MenuLogo.Size = new Size(176, 86);
            MenuLogo.TabIndex = 0;
            // 
            // pictureBox3
            // 
            pictureBox3.Location = new Point(73, 27);
            ...
            pictureBox2.Size = new Size(248, 216);
            ...
            SubmenuInfo.ResumeLayout(false);
            SubmenuConfiguracion.ResumeLayout(false);
            SubmenuReabastecimiento.ResumeLayout(false);
            SubmenuLocalidades.ResumeLayout(false);
            SubmenuSalir.ResumeLayout(false);
            SubmenuDatos.ResumeLayout(false);
            SubmenuEncargues.ResumeLayout(false);
        ...
        private Panel SubmenuDatos;
        private FontAwesome.Sharp.IconButton btnNosotros;
        private Panel SubmenuEncargues;
        private FontAwesome.Sharp.IconButton btnListaEncargues;
        private FontAwesome.Sharp.IconButton btnEncargues;
        private Panel SubmenuSalir;
        private FontAwesome.Sharp.IconButton btnSalirDelSistema;
        private FontAwesome.Sharp.IconButton btnSalir;
        private FontAwesome.Sharp.IconButton btnDatos;
        ...
        private FontAwesome.Sharp.IconButton btnReabastecimiento;
        private PictureBox pictureBox3;
        private PictureBox pictureBox2;
        private Label label1;
        private FontAwesome.Sharp.IconButton btnBebidas;
        private FontAwesome.Sharp.IconButton btnSanguches;
        private FontAwesome.Sharp.IconButton btnHamburguesas;
