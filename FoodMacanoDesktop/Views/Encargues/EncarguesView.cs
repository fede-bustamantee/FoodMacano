    ...
    public partial class EncarguesView : Form
    {
        ...
        private void ActualizarListBoxEncargues()
        {
            ...
            if (encargues.Any())
            {
                ...
                {
                    listBoxEncargues.Items.Add($"{encargue.Cantidad}x {encargue.NombreProducto} - ${encargue.Precio * encargue.Cantidad}");
                }
            }
            else
            {
        ...
        private void MostrarEncargue(Encargue encargue)
        {
            if (encargue != null)
            {
                ...
                lblDatosEncargue.Text = $"{encargue.Cantidad}x {encargue.NombreProducto} - ${encargue.Precio * encargue.Cantidad}";
