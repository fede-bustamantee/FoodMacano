...
namespace BackFoodMacano.Migrations
{
    ...
    [Migration("20250210120629_modificacionDesktop")]
    partial class modificacionDesktop
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodMacanoServices.Models.DesktopDetalleEncargue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DesktopEncargueId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DesktopEncargueId");

                    b.ToTable("DesktopDetalleEncargue");
                });
            ...
            modelBuilder.Entity("FoodMacanoServices.Models.DesktopDetalleEncargue", b =>
                {
                    b.HasOne("FoodMacanoServices.Models.DesktopEncargue", null)
                        .WithMany("Detalles")
                        .HasForeignKey("DesktopEncargueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
