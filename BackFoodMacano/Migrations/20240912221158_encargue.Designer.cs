...
namespace BackFoodMacano.Migrations
{
    ...
    [Migration("20240912221158_encargue")]
    partial class encargue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackFoodMacano.Models.CarritoCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackFoodMacano.Models.Encargue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Estado = "Pendiente",
                            FechaEncargue = new DateTime(2024, 9, 11, 19, 11, 55, 326, DateTimeKind.Local).AddTicks(3485),
                            Total = 100.00m
                        },
                        new
                        {
                            Id = 2,
                            Estado = "Completado",
                            FechaEncargue = new DateTime(2024, 9, 12, 19, 11, 55, 326, DateTimeKind.Local).AddTicks(3567),
                            Total = 200.00m
                        });
                });

            modelBuilder.Entity("BackFoodMacano.Models.Negocio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackFoodMacano.Models.RedesSocial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackFoodMacano.Models.CarritoCompra", b =>
                {
                    b.HasOne("BackFoodMacano.Models.Encargue", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("BackFoodMacano.Models.Negocio", b =>
                {
                    b.HasOne("BackFoodMacano.Models.RedesSocial", "RedesSocial")
                        .WithMany()
